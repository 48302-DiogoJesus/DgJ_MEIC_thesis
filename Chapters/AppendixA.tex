...
% !TEX root = ../main.tex
% #############################################################################
\chapter{Structure of Workflows used for Evaluation}
\label{chapter:appendixA}

\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth, height=0.85\textheight]{images/mine/dag_image_gemm.png}
    \caption{Matrix Multiplication Workflow (Partial)}
    \label{fig:matrix_multiplication}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth, height=0.85\textheight]{images/mine/dag_image_tree_reduction.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.10\textwidth, height=0.35\textheight]{images/mine/dag_image_text_analysis.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.10\textwidth, height=0.5\textheight]{images/mine/dag_image_image_transformer.png}
