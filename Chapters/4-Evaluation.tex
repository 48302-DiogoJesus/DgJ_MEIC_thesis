...
\begin{figure}[H]
    ...
    \caption{\textit{Waiting for dependencies} distribution between planners}
...
\begin{figure}[H]
    ...
    \caption{\textit{Worker startup time} distribution between planners}
    \label{fig:worker_stime_dist}
\end{figure}

\subsection{Optimizations}
TODO: Time Breakdown Analysis + warm vs cold starts
