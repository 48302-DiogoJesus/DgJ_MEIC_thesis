...
%TODO: say that they must implement `planning_assignment_logic' which is called by the planners for each optimization chosen by the user

% #############################################################################

\section{Decentralized Scheduling}
\label{s:decentralized_scheduling}
% todo: go through the default worker execution logic
