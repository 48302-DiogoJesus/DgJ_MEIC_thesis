...
During workflow execution, the client can monitor the workflow's progress through a simple web dashboard, showcased in Figure~\ref{fig:workflow_realtime_dashboard}, implemented with Streamlit~\footnote{\url{https://streamlit.io/}}. This dashboard can be used to visualize the workflow graph in real-time, as it indicates which tasks have been completed (in green) and which remain pending (in gray).

\begin{figure}[h]
    \centering
    \includegraphics[width=1.1\textwidth]{images/mine/realtime dashboard.png}
    \caption{Workflow Real-time Dashboard}
    \label{fig:workflow_realtime_dashboard}
\end{figure}
